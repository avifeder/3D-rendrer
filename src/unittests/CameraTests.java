...
public class CameraTests {
    ...
    /**
     * Test method for {@link elements.Camera##Camera(Point3D, Vector, Vector)}
     */
    @Test
    public void testConstructor() {
        try{
            // TC01: not orthogonal vectors
            new Camera(Point3D.ZERO, new Vector(1,0,0), new Vector(1,2,4));
            fail("ERROR: not orthogonal vectors does not throw an exception");
        }
        catch (Exception e){}
    }
    /**
